  ...
  return (
        <TouchableOpacity style={[CommonCardStyles.cardBorder, styles.container]}>
          <View style={styles.imageContainer}>
            <Image resizeMode="cover" style={styles.imageStyles} source={{uri: "https://ptzgovorit.ru/sites/default/files/original_nodes/0eeireesjfk.jpg"}} />
          </View>
          <View style={styles.sideContainer}>
            ...
            <View style={styles.bottomContainerStyles}>
              <IconWithCaption iconName={'account'} caption={users}></IconWithCaption>
              <IconWithCaption iconName={'clock-outline'} caption={time}></IconWithCaption>
              <IconWithCaption iconName={'map-marker-outline'} caption={distance}></IconWithCaption>
            </View>
