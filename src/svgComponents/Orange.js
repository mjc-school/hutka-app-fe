    ...
    return (
        ...
        >
            ...
            <Path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M74.614 67.059v-.02l.001-.093V44.422c0-9.126-7.37-16.511-16.448-16.511s-16.45 7.385-16.45 16.511v8.171a4.397 4.397 0 01-4.393 4.401H19.846a.217.217 0 00-.213.221c0 14.451 11.674 26.154 26.06 26.154h12.833c8.879 0 16.09-7.224 16.09-16.151l-.001-.14v-.02zm-34.53-22.637c0-10.02 8.096-18.142 18.083-18.142 9.986 0 18.082 8.122 18.082 18.142v22.436l-.001.199v.16C76.249 77.04 68.315 85 58.527 85H45.692C30.398 85 18 72.56 18 57.215a1.85 1.85 0 011.846-1.852h17.478c1.525 0 2.76-1.24 2.76-2.77v-8.171z"
                fill="#333"
            />
            <Path
                d="M36 42H25.375M36 46.25H22.187M36 50.5H19"
                stroke="#333"
                strokeWidth={1.594}
                strokeLinecap="round"
            />
            <Path
                d="M72.437 39.328c0-.898-.73-1.625-1.632-1.625H45.311c-.9 0-1.63.727-1.63 1.625v.51c0 3.912 2.906 7.084 6.493 7.084 3.586 0 6.493-3.172 6.493-7.085h2.783c0 3.913 2.907 7.085 6.493 7.085 3.587 0 6.494-3.172 6.494-7.085v-.509z"
                fill="#333"
            />
            <Path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M46.174 42.147a.817.817 0 011.11.317 2.897 2.897 0 002.535 1.491.816.816 0 110 1.63 4.53 4.53 0 01-3.962-2.33.814.814 0 01.317-1.108zM62.291 42.147a.817.817 0 011.11.317 2.897 2.897 0 002.535 1.491.816.816 0 110 1.63 4.53 4.53 0 01-3.963-2.33.814.814 0 01.318-1.108zM81.042 48.571a2.896 2.896 0 01-2.079 3.518l-9.686.943 9.492.64a2.893 2.893 0 012.315 3.363 2.875 2.875 0 01-3.34 2.332l-16.522-3.015a2.888 2.888 0 01-2.359-2.748 2.891 2.891 0 012.165-2.906l16.522-4.22a2.872 2.872 0 013.492 2.093z"
                fill="#fff"
            />
            <Path
                fillRule="evenodd"
