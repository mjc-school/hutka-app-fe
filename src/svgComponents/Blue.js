    ...
    return (
        ...
        >
            <Path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M44.7 20.11a1.349 1.349 0 011.776.716l3.247 7.63a1.366 1.366 0 01-.71 1.788 1.349 1.349 0 01-1.777-.715l-3.246-7.63a1.366 1.366 0 01.71-1.789zM50.128 20.11a1.37 1.37 0 011.796.716l3.282 7.63a1.36 1.36 0 01-.718 1.788 1.37 1.37 0 01-1.796-.715l-3.283-7.63a1.36 1.36 0 01.719-1.789zM55.544 20.11a1.37 1.37 0 011.796.716l3.282 7.63a1.36 1.36 0 01-.718 1.788 1.37 1.37 0 01-1.796-.715l-3.283-7.63a1.36 1.36 0 01.719-1.789z"
                fill="#333"
            />
            <Path
            ...
            />
            <Path
                d="M48 43.38a2.906 2.906 0 015.694 0M63.106 43.38a2.906 2.906 0 015.694 0"
                stroke="#333"
                strokeWidth={1.743}
                strokeLinecap="round"
            />
