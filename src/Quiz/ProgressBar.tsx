...
const ProgressDash = ({passed}: {passed: boolean, })=> (
    <View style={{ flex: 1, width: "5%",height: 5, margin: 5, backgroundColor: passed ? Colors.accent: Colors.greyLight  }}/>
)

export const ProgressBar = (props: {maxItems: number,currentItem: number }) => {
    ...
    const Dashes = useMemo(()=>{
        ...
        const replacer = (val, currentIndex) => {
            ...
            return(<ProgressDash key={currentIndex} passed={currentIndex <= currentItem}/>);}
